...
export default function SmokeSignalPage() {
    ...
    return (<>
        ...
        <ImageSection imgSrc="/images/programs/smokesignal/main.png" title='Simple, but Extensible'>
        ...
        <ImageSideSection big imgSrc="/images/programs/smokesignal/Client.png">
