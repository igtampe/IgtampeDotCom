...
export default function AtlasPage(){
    ...
    return(<>
     <ProgramHeader name="Atlas" git="https://github.com/igtampe/Atlas" site="https://umswiki.igtampe.com" />
        ...
        <ImageSection imgSrc='/images/programs/atlas/main.png' title='A small wiki application'>
            Though small, Atlas lets you create your own Wiki, including live editing, permissions, and even image management.
        </ImageSection>

        <ImageSideSection imgSrc="/images/programs/atlas/ums.png">
        ...
        <ImageSideSection imgSrc="/images/programs/atlas/edit.png" right>
        ...
        <ImageSideSection imgSrc="/images/programs/atlas/image.png">
        ...
        <ImageSection imgSrc='/images/programs/atlas/chopo.png'/>
        <ElevatedSection title='Its current use'>
            Atlas was developed as a wiki engine primarily to be used as a replacement to the original <Link href='/pastimes/ums'>UMS</Link> Wiki. We hope to expand
