...
export default function VibePage({
    ...
    return (<>
        ...
        <ElevatedSection>
            <ImageSection imgSrc="/images/programs/vibe/everything.png" Vertical={Vertical}/>
        ...
        <ImageSection title='Powered by SmokeSignal' right imgSrc="/images/programs/vibe/server.png" Vertical={Vertical}>
        ...
        <ImageSection title='Other Programs' imgSrc="/images/programs/vibe/bwbg.png" Vertical={Vertical}>
