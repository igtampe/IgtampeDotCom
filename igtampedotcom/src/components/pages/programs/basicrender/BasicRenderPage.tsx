...
export default function BasicRenderPage() {
    ...
    return (<>
        ...
        <ImageSection imgSrc="/images/programs/basicrender/hcdemo.png" verticalOverride title='Console Graphics made Easy'>
        ...
        <div style={{ marginTop: '20px' }} />
        <ImageSideSection imgSrc="/images/programs/basicrender/hcpicker.png" big imgDesc="Henja3's custom color picker, showing sliders, graphics, labels, and buttons">
