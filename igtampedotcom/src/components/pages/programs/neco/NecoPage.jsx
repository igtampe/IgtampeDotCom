...
export default function NecoPage({
    ...
    return (<>
        ...
        <ImageSection imgSrc="/images/programs/neco/main.png" Vertical={Vertical} title='A Complete Overhaul'>
        ...
        <ImageSection imgSrc="/images/programs/neco/admin.png" Vertical={true} title='Ready for the Future'> 
