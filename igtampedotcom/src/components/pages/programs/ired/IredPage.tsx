...
export default function IredPage(){
    ...
    return(<>
        ...
        <ImageSection title='All you need for an API' imgSrc="https://raw.githubusercontent.com/igtampe/Igtampe.Redistributables/master/Images/Diagram%20(Horiz).png" verticalOverride>
        ...
        <ImageSideSection right big imgSrc="https://raw.githubusercontent.com/igtampe/Igtampe.Redistributables/master/Images/idacra_server.png"
        ...
        <ImageSideSection imgSrc="/images/programs/neco/main.png">
