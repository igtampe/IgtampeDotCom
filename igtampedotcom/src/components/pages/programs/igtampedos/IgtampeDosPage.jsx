...
export default function IgtampeDosPage({
    ...
    return(<>
        ...
        <ImageSideSection Vertical={Vertical} imgSrc="/images/programs/igtdos/ntabout.png">
        ...
        <ImageSideSection Vertical={Vertical} imgSrc="/images/programs/igtdos/nabas.png" right>
        ...
        <ImageSideSection Vertical={Vertical} imgSrc="/images/programs/igtdos/internet.png">
