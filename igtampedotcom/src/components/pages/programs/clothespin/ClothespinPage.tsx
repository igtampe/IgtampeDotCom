...
export default function ClothespinPage() {
    ...
    return (<>
        ...
        <ImageSection title="Clothes Tracking made Easy" imgSrc="/images/programs/clothespin/main.png">
        ...
        <ImageSideSection big imgSrc="/images/programs/clothespin/home.png">
        ...
        <ImageSideSection big imgSrc="/images/programs/clothespin/outfits.png" right>
        ...
        <ImageSideSection imgSrc="/images/programs/clothespin/mobile.png" big>
