...
export default function ClothespinPage({
    ...
    return (<>
        ...
        <ImageSideSection imgSrc="/images/programs/clothespin/home.png" Vertical={Vertical}>
        ...
        <ImageSideSection imgSrc="/images/programs/clothespin/outfits.png" right Vertical={Vertical}>
