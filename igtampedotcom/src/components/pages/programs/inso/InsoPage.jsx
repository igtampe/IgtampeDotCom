...
export default function InsoPage({
    ...
    return (<>
        <ImageSideSection imgSrc="/images/programs/inso/classtrack.png" right big Vertical={Vertical}>
        ...
        <ImageSideSection imgSrc="/images/programs/inso/spot.png" big Vertical={Vertical}>
        ...
        <ImageSideSection imgSrc="/images/programs/inso/amie.png" big right Vertical={Vertical}>
        ...
        <ImageSideSection right imgSrc="/images/programs/inso/macademia.png" big Vertical={Vertical}>
