...
export default function JavaPage() {
    ...
    return (<>
        ...
        <ImageSideSection imgSrc="/images/programs/java/latenight.png" big right>
        ...
        <ImageSideSection imgSrc="/images/programs/java/mirror.png" big>
            ...
            <ElevatedSection>
                ...
                <p>I considered it a bit of a challenge to design the swing interfaces and write the code. However, using my previous experience in VB.NET,
                    I was able to complete the two programs. These two utilities have since become indispensable in the construction of the <Link href='/pastimes/ums'>UMS</Link>.</p>
            </ElevatedSection>
        </ImageSideSection>

        <ImageSideSection imgSrc="/images/programs/java/data.png" big right>
        ...
        <ImageSideSection imgSrc="/images/programs/java/magtape.png" big>
