...
export default function UMSWebPage({
    ...
    return(<>
        ...
        <ImageSection title="Batch at its limits" Vertical={Vertical} imgSrc="/images/programs/umsweb/main.png">
        ...
        <ImageSideSection Vertical={Vertical} imgSrc="/images/programs/umsweb/login.png">
        ...
        <ImageSideSection Vertical={Vertical} right imgSrc="/images/programs/umsweb/launch.png">
        ...
        <ImageSideSection Vertical={Vertical} imgSrc="/images/programs/umsweb/home.png">
        ...
        <ImageSideSection Vertical={Vertical} right imgSrc="/images/programs/umsweb/limitations.png">
        ...
        <ImageSideSection Vertical={Vertical} imgSrc="/images/programs/umsweb/eos.png">
