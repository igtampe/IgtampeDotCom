...
import pastimesList from './PastimesList.json'
import PastimeCard from "../pastimes/PastimeCard";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <ImageSection imgSrc="/images/homeMain.jpg" title='Myself' right>
      ...
      <ElevatedSection>
        ...
        <Section title='Out in the Open Ocean' style={{ marginTop: "40px" }}>
          <p>
            ...
            writing personal projects will be a lot more limited. Still, I try to make a few projects on the side, both coding and non-coding.
          </p>
          <p>
      ...
      <Divider style={{ marginTop: '20px', marginBottom: '20px' }} />
      <ImageSection right imgSrc="/images/CodeScreenshot.png" title='My Code'>
      ...
      <Divider style={{ marginTop: '20px', marginBottom: '20px' }} />
      <ImageSection imgSrc="/images/OMTATDonation.jpg" title='My Past'>
      ...
      <Divider style={{ marginTop: '20px', marginBottom: '20px' }} />
      <ImageSection imgSrc="/images/umsmap.png" title='My Free Time'>
