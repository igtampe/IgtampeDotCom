...
export default function UMSPage() {
    ...
    ///images/pastimes/ums/main.jpg
    return (<>
        <ProgramHeader name='The Ultra Modern Sector (The UMS)' />
        <ImageSection imgSrc="/images/pastimes/ums/main.jpg" title='A Nation all its own' right>
            Spanning over 6km by 4km, the UMS has been a massive passion project.
        </ImageSection>

        <ImageSideSection imgSrc="/images/pastimes/ums/history.jpg" big>
        ...
        <ImageSideSection imgSrc="/images/pastimes/ums/paradisus.jpg" big right  imgDesc="The Minotaur, the UMS Government's central building, behind Laertes Central Park">
        ...
        <ImageSideSection imgSrc="/images/pastimes/ums/ocko.jpg" big  imgDesc="The second UMS National Bank Tower in South Osten">
        ...
        <ImageSideSection imgSrc="/images/umsmap.png" big  right>
        ...
        <ImageSection imgSrc="/images/pastimes/ums/newpondnight.jpg" title="The end of an era" verticalOverride>
